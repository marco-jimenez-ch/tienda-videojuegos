...
$(function () {
  ...
  $('#formNuevaPassword').validate({
    ...
    submitHandler: function (form, event) {
      event.preventDefault();
      $('#pasaNuevaPassword').html('<div class="form-card"><div class="card-body p-4 text-center"><h3>Contraseña actualizada</h3><p style="color:var(--muted)">Tu contraseña fue cambiada exitosamente.</p><div class="mt-4"><a href="/login/" class="btn btn-primary">Ir al login</a></div></div></div>');
    }
  });
